...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="bg-lighttext-white py-2">
        <div class="container">
            <div class="row mt-2" id="Row">
                <h3 class="lead " style="font-size:30px; font-weight:bold ;"><i class="fas fa-folder-plus px-2"></i> MANAGE CATEGORIES </h3>
            </div>
        </div>
    </header>
    <!-- HEADER END -->
                ...
                <form class="form" action="Categories.php" method="post">
                    <div class="card bg-dark text-light mb-3 shadow-lg">
                        ...
                        <div class="card-body bg-light">
                            <div class="form-group"><label for="title"> <span class="FieldInfo"> Category Title: </span></label>
    ...
    <script>
        <?php require_once("scripts/AddNewCategory.js"); ?>
    </script>
</body>
