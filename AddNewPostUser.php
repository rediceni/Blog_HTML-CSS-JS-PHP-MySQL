...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="myCollapse" style="justify-content: space-around;">
                <ul class="navbar-nav">
                    ...
                    <!-- 3 -->
                    <li class="nav-item px-3">
                        <a href="#" class="nav-link text-info"><i class="fas fa-edit"></i> Add New Post</a>
                    </li>
                    <!-- 4 -->
                    <li class="nav-item px-3">
    ...
    <header class="bg-lighttext-white py-2">
        <div class="container">
            <div class="row mt-2" id="Row">
                <h3 class="lead " style="font-size:30px; font-weight:bold ;"><i class="fas fa-edit"></i> ADD NEW POST </h3>
            </div>
        </div>
    </header>
    <!-- HEADER END -->
    ...
    <section class="container py-2 mb-4">
        <div class="row">
            <div class="offset-lg-1 col-lg-10" style="padding:20px;">
                ...
                <form class="form" action="AddNewPost.php" method="post" enctype="multipart/form-data"><!-- enctype is used to handle the images -->
                        ...
                        <div class="card-body bg-light">
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label for="imageSelect" class="custom-file-label" id="imageLabel"> Select Image . . . </label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    <button type="submit" name="Submit" class="btn btn-success btn-block" id="">
    ...
    <script>
        <?php require_once("scripts/AddNewPost.js"); ?>
    </script>
</body>
